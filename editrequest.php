                ...
                <table border="0" width="100%" class="table">                 
                    ...
                    ?>
                     ...
                     <tr>
                        <td colspan="2">
                            <center>
                                 <input type="submit" value="Update Request" name="submit" style="margin-top:15px;cursor:pointer;">
                                 <input type="button" value="Back to original" name="reset" onclick="location.reload(true);" style="cursor:pointer;">
                                 <input type="button" value="Cancel" name="cancel" onclick="window.history.back();" style="cursor:pointer;">
                            </center>
                        </td>
                     </tr>  
                </table>
