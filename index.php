...
<div id="pageContent">
    <div id="rounded">
        <div id="main" class="container">
                ...
                <div id="logout"><a href="logout.php?logout=1" title="Log-out" style="text-decoration:none;color:#ADD8E6;"><h3>L<img  src="images/logout_button.png" style="width:20px;height:20px" alt="Log-out User" title="Log-out"/>gout</h3></a></div>  
            ...
            <div id="wrapper">
                ...
                <nav role="navigation" id="access">
                  <ul id="menu">
                        ...
                        <!--<ul id ='menu1'>
                        <li><a  target='myiframe' href='resign.php'>Re-sign Vad</a>
                        <ul class ='sub_home'>
                        <li><a target='myiframe' href ='requestresign.php'>Resign List</a></li>
                        </ul>-->
                            <?php 
                                    ...
                                    while($adminrow = mysql_fetch_array($adminresult)){  
                                        if($username==$adminrow['admin']){
                                            //echo "<ul id ='menu1'>";
                                            echo "<li><a  target='myiframe' href='resign.php'>Re-sign Vad</a>"; 
                                            //echo "<ul class ='sub_home'>";
                                            //echo"<li>";
                                            //echo "<a target='myiframe' href ='requestresign.php'>Resign List</a>";
                                            //echo "</li>";
                                            //echo "</ul>";
  										    echo "</li>";
											//echo "</ul>";
