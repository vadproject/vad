...
<?php
    ...
    {
        echo '<div style="background:white;color:red;padding:10px;float:left;">Account has been deleted!</div>';
    }	

    else if(isset($_GET['adminadded']))
    {
        echo '<div style="background:white;color:red;padding:10px;float:left;">User added as Administrator!</div>';
    }

	else if(isset($_GET['notadded']))
	{
	  	echo '<div style="background:white;color:red;padding:10px;float:left;">User already exists as Administrator!</div>';
	}	
	else if(isset($_GET['invaliduser']))
	{
	  	echo '<div style="background:white;color:red;padding:10px;float:left;">Invalid Username!</div>';
